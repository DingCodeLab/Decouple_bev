...
class BEVFusion(Base3DFusionModel):
    def __init__(
        ...
        **kwargs,
        ...
        self.random_bev_feat_mask_ratio = random_bev_feat_mask_ratio
    ...
    def forward_single(
        ...
        **kwargs,
        ...
        if self.drop_modality is not None and self.training:
            ...
            elif self.drop_modality == 'lidar' and np.random.rand() < 0.75:
                features[1] = features[1]*0
        
        if self.drop_modality is not None and not self.training:
            if self.drop_modality == 'camera':
                features[0] = features[0]*0
            elif self.drop_modality == 'lidar':
                features[1] = features[1]*0
